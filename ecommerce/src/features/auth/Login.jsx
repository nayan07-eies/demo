      ...
      <div className="bg-white p-12 rounded-[3rem] border border-slate-200 shadow-2xl shadow-cyan-900/5 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Access Node</h1>
            <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mt-3 leading-relaxed">Secure Terminal Authentication</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div>
              <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 mb-3 ml-1">Identity Protocol</label>
            ...
            <div>
              <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 mb-3 ml-1">Security Key</label>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-slate-900 text-white py-5 rounded-[2rem] font-black uppercase tracking-[0.2em] text-xs hover:bg-cyan-500 hover:text-slate-900 transition-all duration-300 disabled:opacity-50 shadow-lg shadow-slate-200 hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] active:scale-[0.98]"
            >
          ...
          <div className="mt-12 pt-8 border-t border-slate-100">
            ...
            <p className="text-center text-xs font-mono bg-slate-50 p-3 rounded-xl border border-slate-200 text-slate-500 shadow-inner">
