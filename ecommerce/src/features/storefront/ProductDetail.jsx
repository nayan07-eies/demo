    ...
    <div className="max-w-7xl mx-auto text-slate-600 dark:text-slate-300">
      ...
      <div className="grid grid-cols-12 gap-12 lg:gap-24">
        ...
        <div className="col-span-12 lg:col-span-7">
          <div className="aspect-[4/5] rounded-[3rem] overflow-hidden bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl shadow-cyan-900/5 relative group">
            <img
              src={product.image}
              alt={product.name}
        ...
        <div className="col-span-12 lg:col-span-5 flex flex-col justify-center">
          <div>
            ...
            <div className="prose prose-lg text-slate-500 dark:text-slate-400 font-medium mb-12 leading-relaxed max-w-none">
            ...
            <div className="mb-16">
              <button
                ...
                className={`w-full py-6 rounded-2xl font-black uppercase tracking-widest text-sm flex items-center justify-center space-x-3 transition-all duration-300 shadow-xl ${
                  product.stock > 0 
                    ? 'bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-cyan-500 dark:hover:bg-cyan-500 shadow-slate-200 dark:shadow-none hover:shadow-[0_0_20px_rgba(255,107,53,0.4)] active:scale-[0.98]' 
          ...
          <div className="grid grid-cols-3 gap-4 lg:gap-8 py-10 border-t border-slate-200 dark:border-slate-800">
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 bg-slate-50 dark:bg-slate-950 rounded-2xl flex items-center justify-center mb-4 border border-slate-100 dark:border-slate-800">
                <Truck className="w-6 h-6 text-slate-900 dark:text-white" />
              </div>
              <span className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-tight">Node<br/>Transfer</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 bg-slate-50 dark:bg-slate-950 rounded-2xl flex items-center justify-center mb-4 border border-slate-100 dark:border-slate-800">
                <ShieldCheck className="w-6 h-6 text-slate-900 dark:text-white" />
              </div>
              <span className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-tight">Secure<br/>Protocol</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 bg-slate-50 dark:bg-slate-950 rounded-2xl flex items-center justify-center mb-4 border border-slate-100 dark:border-slate-800">
                <RefreshCcw className="w-6 h-6 text-slate-900 dark:text-white" />
              </div>
              <span className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-tight">Data<br/>Reversal</span>
            </div>
          </div>
        </div>
      </div>
